...
var services_data = [{ name: "About", icon: "industries" }, { name: "History", icon: "validation" }, { name: "Google", icon: "engineering" }, { name: "Udacity", icon: "management" }, { name: "Interests", icon: "manufacturing" }, { name: "Open Source", icon: "technical" }, { name: "Projects", icon: "process" }];
